...
app.get("/secrets", async (req, res) => {
  if (req.isAuthenticated()) {
    try {
      // selecting secret of the user who logged in
      ...
      if (secret) {
        ...
        res.render("secrets.ejs", {secret: "You should submit a secret Secret"});
      }
    } catch (error) {
      console.error(error);
    }
...
app.post("/submit",async (req,res)=>{
  ...
  console.log(req.user); //checking which user login
